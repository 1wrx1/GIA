...
def grid_plot(tensor, args, ds, dm):
    ...
    if args.pretrain:
        if 'vit' in args.arch:
            file_name = 'saved_img/' + args.arch + '_' + args.dataset + '_bs_' + str(args.bs) + '_act_' + args.act + '_patch_' + str(args.patch) + '_pretrain' + '.pdf'
        else:
            if args.defense == 'no_defense':
                file_name = 'saved_img/' + args.arch + '_' + args.dataset + '_bs_' + str(args.bs) + '_act_' + args.act + '_no_defense_' + '_pretrain' + '.pdf'
            elif args.defense == 'noise':
                file_name = 'saved_img/' + args.arch + '_' + args.dataset + '_bs_' + str(args.bs) + '_act_' + args.act + '_noise_' + str(args.noise) + '_pretrain' + '.pdf'
            elif args.defense == 'prun':
                file_name = 'saved_img/' + args.arch + '_' + args.dataset + '_bs_' + str(args.bs) + '_act_' + args.act + '_prun_' + str(args.p) + '_pretrain' + '.pdf'
            elif args.defense == 'soteria':
                file_name = 'saved_img/' + args.arch + '_' + args.dataset + '_bs_' + str(args.bs) + '_act_' + args.act + '_soteria_' + str(args.p) + '_pretrain' + '.pdf'
            elif args.defense == 'no_fc':
                file_name = 'saved_img/' + args.arch + '_' + args.dataset + '_bs_' + str(args.bs) + '_act_' + args.act + '_no_fc_' + '_pretrain' + '.pdf'
        
    else:
        if 'vit' in args.arch:
            file_name = 'saved_img/' + args.arch + '_' + args.dataset + '_bs_' + str(args.bs) + '_act_' + args.act + '_patch_' + str(args.patch) + '.pdf'
        else:
            if args.defense == 'no_defense':
                file_name = 'saved_img/' + args.arch + '_' + args.dataset + '_bs_' + str(args.bs) + '_act_' + args.act + '_no_defense_' + '.pdf'
            elif args.defense == 'noise':
                file_name = 'saved_img/' + args.arch + '_' + args.dataset + 'bs_' + str(args.bs) + '_act_' + args.act + '_noise_' + str(args.noise) + '.pdf'
            elif args.defense == 'prun':
                file_name = 'saved_img/' + args.arch + '_' + args.dataset + '_bs_' + str(args.bs) + '_act_' + args.act + '_prun_' + str(args.p) + '.pdf'
            elif args.defense == 'soteria':
                file_name = 'saved_img/' + args.arch + '_' + args.dataset + '_bs_' + str(args.bs) + '_act_' + args.act + '_soteria_' + str(args.p) + '.pdf'
            elif args.defense == 'no_fc':
                file_name = 'saved_img/' + args.arch + '_' + args.dataset + '_bs_' + str(args.bs) + '_act_' + args.act + '_no_fc_' + '.pdf'
